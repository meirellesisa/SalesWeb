...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        //reponsavel por popular minha base de dados 
        public void Seed()
        {
            //testar se já existe algum dado na minha tabela ou 
            if (_context.Department.Any() || _context.SalesRecord.Any())
            {
                return; // db já populado não faz nada 
            }

            //populando banco lembrando que usamos a forma de trabalhar 
            // WORKFLOW -> CODEFIRST
            ...
            Department d5 = new Department(4, "Sale");
            ...
            SalesRecord r9 = new SalesRecord(9, new DateTime(2018, 09, 14), 11000.0, SaleStatus.Pedding, s6);
            ...
            SalesRecord r12 = new SalesRecord(12, new DateTime(2018, 09, 25), 7000.0, SaleStatus.Pedding, s3);
            ...
            SalesRecord r27 = new SalesRecord(27, new DateTime(2018, 10, 13), 9000.0, SaleStatus.Pedding, s1);
